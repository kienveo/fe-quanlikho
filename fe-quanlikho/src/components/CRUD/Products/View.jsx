...
const ViewProduct = () => {
  ...
  const product = {
    ...
    status: "active",
    description:
      "Laptop Dell XPS 13 với hiệu năng mạnh mẽ, thiết kế sang trọng và màn hình 13.4 inch 4K. Phù hợp cho công việc và giải trí.",
            ...
            <div className="card-body">
              <div className="row g-3">
                ...
                <div className="col-12">
                  ...
                  <div className="form-control-plaintext">{product.description}</div>
                </div>
                <div className="col-md-6">
                  <label className="form-label fw-semibold">Ngày tạo</label>
                  <div className="form-control-plaintext">{product.createdAt}</div>
                </div>
                <div className="col-md-6">
                  <label className="form-label fw-semibold">Ngày cập nhật</label>
                  <div className="form-control-plaintext">{product.updatedAt}</div>
                </div>
              </div>
            </div>
          </div>
